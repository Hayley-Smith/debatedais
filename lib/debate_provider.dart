...
class DebateProvider extends ChangeNotifier {
  final Debate _sampleDebate = Debate(
    debateId: 'debateId',
    userIdPro: 'userIdPro',
    userIdCon: 'userIdCon',
  ...
  final List<Debate> _debates = [
    Debate(
      ...
      argumentFor3: Argument(
        text: 'School uniforms can contribute to a safer school environment by easily identifying outsiders.',
        timeStamp: DateTime.now(),
      ...
      argumentAgainst2: Argument(
        text: 'Parents should have the freedom to choose clothing for their children, and mandatory uniforms violate this right.',
        timeStamp: DateTime.now(),
        argumentId: 'argumentAgainst2',
        userId: 'user2',
      ),
      argumentAgainst3: Argument(
        text: 'Schools should focus on addressing underlying issues like bullying instead of enforcing uniform policies.',
        timeStamp: DateTime.now(),
    ...
    Debate(
      ...
      argumentFor1: Argument(
        text: 'Social media facilitates communication and connection between people around the world. Social media facilitates communication and connection between people around the world. Social media facilitates communication and connection between people around the world. Social media facilitates communication and connection between people around the world. Social media facilitates communication and connection between people around the world. Social media facilitates communication and connection between people around the world. Social media facilitates communication and connection between people around the world.',
        timeStamp: DateTime.now(),
        argumentId: 'argumentFor1',
        userId: 'user3',
      ),
      argumentFor2: Argument(
        text: 'Social media platforms provide a platform for activism and raising awareness about important issues.',
        timeStamp: DateTime.now(),
        argumentId: 'argumentFor2',
        userId: 'user3',
      ),
      argumentFor3: Argument(
        text: 'Businesses benefit from social media by reaching a wider audience and engaging with customers.',
        timeStamp: DateTime.now(),
        argumentId: 'argumentFor3',
        userId: 'user3',
      ),
      argumentAgainst1: Argument(
        text: 'Excessive use of social media can lead to mental health issues such as anxiety and depression.',
        timeStamp: DateTime.now(),
        argumentId: 'argumentAgainst1',
        userId: 'user4',
      ),
      argumentAgainst2: Argument(
        text: 'Social media platforms can contribute to the spread of misinformation and fake news.',
        timeStamp: DateTime.now(),
        argumentId: 'argumentAgainst2',
        userId: 'user4',
      ),
      argumentAgainst3: Argument(
        text: 'Privacy concerns arise with the collection and use of personal data by social media companies.',
        timeStamp: DateTime.now(),
        argumentId: 'argumentAgainst3',
        userId: 'user4',
      ),
  ...
  //Debate get _sampleDebate => sampleDebate;
