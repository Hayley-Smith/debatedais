...
class OpenDebateProvider extends ChangeNotifier {
  ...
  late OpenDebate _selectedOpenDebate = _openDebates[0]; // Initialize with a default value
  OpenDebate get selectedOpenDebate => _selectedOpenDebate;

  List<OpenDebate> get openDebates => _openDebates;

  void setSelectedOpenDebate(OpenDebate openDebate) {
